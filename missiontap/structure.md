...
由于 Yaml 对格式的要求十分严格，不亚于 Python，因此请确保：<br>
<ol><li>缩进正确：物品、生物的名称必须位于该要求类型的下一级，具体见上方示例；</li><li>区分大小写：要求类型（<code>blockbreak</code>, <code>breeding</code> 等）必须为小写，物品、生物名称必须为大写；</li><li>注意空格：在每个键与值（例如 <code>WHEAT: 100</code>）之间，必须加上冒号 <code>:</code> 和空格。<strong>不可</strong>写作 <code>WHEAT:100</code>。</li></ol>
</div>

<div class="tip-section">
若要表示「任意」，可以省略物品名称，直接在要求名称后面写数字。例如
...
代表任意破坏 200 个方块、任意击杀 500 个生物和制造 56 个铁斧。
</div>
